...
<header>
	<blockquote>
		...
		<input class ="hi" style = "float: right; margin 2%;" type="button" name="Отмена" value="Home" onclick="window.location='index.php';" />
	</blockquote>
</header>
<?php
session_start();
...
<input class="button" style="float: right;" type="button" name="Отмена" value="Continue Shopping" onclick="window.location='index.php';" />
...
<input class="button" type="button" name="Отмена" value="Cancel" onClick="window.location='index.php';" />
